...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to data_dense.yaml or data.zip (with data_dense.yaml inside data.zip). Default is 'coco8.yaml'.
    ...
    def _unzip(path):
        """Unzip data.zip."""
        if not str(path).endswith(".zip"):  # path is data_dense.yaml
