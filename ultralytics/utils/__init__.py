...
def yaml_save(file="data_dense.yaml", data=None, header=""):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'data_dense.yaml'.
...
def yaml_load(file="data_dense.yaml", append_filename=False):
    """
